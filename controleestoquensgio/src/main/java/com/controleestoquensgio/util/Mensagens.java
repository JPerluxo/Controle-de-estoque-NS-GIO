...
public class Mensagens {
    ...
    public static String tipoDeAcessoNaoEncontrado() { return "Tipo de acesso não encontrado!"; }
    public static String tipoDeColaboradorNaoEncontrado() { return "Tipo de colaborador não encontrado!"; }
    public static String regimeDeTrabalhoNaoEncontrado() { return "Regime de trabalho não encontrado!"; }
    public static String localizacaoNaoEncontrada() { return "Localização não encontrada!"; }
    ...
    public static String insiraNumeroDeSerieOuNumeroDePatrimonio() { return "Insira um número de série ou um número de patrimônio!"; }
    ...
    public static String ocorrenciaNaoEncontrada() { return "Ocorrência não encontrada!"; }
    public static String setorNaoEncontrado() { return "Setor não encontrado!"; }
    public static String presidenciaNaoEncontrada() { return "Presidência não encontrada!"; }
    public static String diretoriaNaoEncontrada() { return "Diretoria não encontrada!"; }
    public static String gerenciaNaoEncontrada() { return "Gerência  não encontrada!"; }
    public static String nucleoNaoEncontrado() { return "Núcleo não encontrado!"; }
    public static String paginaNaoEncontrada() { return "Erro 404: Página não encontrada!"; }
